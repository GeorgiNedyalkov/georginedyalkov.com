...
export const booksData = [
  {
    ...
    outlines a battle plan to conquer this internal foe, then pinpoints just how to achieve the greatest success.Though it was written for writers, 
    it has been embraced by business entrepreneurs, actors, dancers, painters, photographers, filmmakers, military service members and thousands of others around the world.`,
    ...
    sample:
      "https://www.amazon.com/War-Art-Steven-Pressfield-ebook/dp/B007A4SDCG?asin=B007A4SDCG&revisionId=7ab18374&format=1&depth=1",
  },
  {
    id: 2,
    title: "Shōgun",
    ...
    As internal political strife and a clash of cultures lead to seemingly inevitable conflict, Blackthorne’s loyalty and strength of 
    character are tested by both passion and loss, and he is torn between two worlds that will each be forever changed.`,
    genre: "fiction",
    ...
    sample:
      "https://www.amazon.com/Sh%C5%8Dgun-Asian-Saga-Book-1-ebook/dp/B007A4SDCG?asin=B007A4SDCG&revisionId=7ab18374&format=1&depth=1",
  },
  {
    id: 3,
    ...
    genre: "fiction",
    link: "https://www.amazon.com/Fountainhead-Ayn-Rand-ebook/dp/B002OSXDAU/ref=sr_1_1?keywords=The+Fountainhead&s=digital-text&sr=1-1",
    sample:
      "https://www.amazon.com/Fountainhead-Ayn-Rand-ebook/dp/B002OSXDAU/ref=sr_1_1?keywords=the+fountainhead&s=digital-text&sr=1-1&asin=B002OSXDAU&revisionId=d1f7adea&format=1&depth=1",
  },
  {
    id: 4,
